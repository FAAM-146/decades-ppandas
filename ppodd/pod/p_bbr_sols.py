...
class BBRSols(PPBase):
    ...
    def test():
        ...
        return {
            ...
            'UPPBBR_radiometer_1_sig': ('data', 15000 * _o(100), 1),
            'UPPBBR_radiometer_2_sig': ('data', 7000 * _o(100), 1),
            'UPPBBR_radiometer_3_sig': ('data', -54 * _o(100), 1),
            'UPPBBR_radiometer_1_zero': ('data', _z(100), 1),
            'UPPBBR_radiometer_2_zero': ('data', _z(100), 1),
            'UPPBBR_radiometer_3_zero': ('data', _z(100), 1),
            'UPPBBR_radiometer_1_temp': ('data', 20000 * _o(100), 1),
            'UPPBBR_radiometer_2_temp': ('data', 20000 * _o(100), 1),
            'UPPBBR_radiometer_3_temp': ('data', _z(100), 1),
            'LOWBBR_radiometer_1_sig': ('data', 8000 * _o(100), 1),
            'LOWBBR_radiometer_2_sig': ('data', 8000 * _o(100), 1),
            'LOWBBR_radiometer_3_sig': ('data', -38 * _o(100), 1),
            'LOWBBR_radiometer_1_zero': ('data', _z(100), 1),
            'LOWBBR_radiometer_2_zero': ('data', _z(100), 1),
            'LOWBBR_radiometer_3_zero': ('data', _z(100), 1),
            'LOWBBR_radiometer_1_temp': ('data', 20000 * _o(100), 1),
            'LOWBBR_radiometer_2_temp': ('data', 20000 * _o(100), 1),
            'LOWBBR_radiometer_3_temp': ('data', -10000 * _o(100), 1)
        }
