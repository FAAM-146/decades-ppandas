...
class TeiOzone(PPBase):
    ...
    inputs = ["TEIOZO_conc", "TEIOZO_flag", "TEIOZO_FlowA", "TEIOZO_FlowB", "WOW_IND"]
    ...
    def test():
        return {
            ...
            "TEIOZO_FlowA": ("data", 0.7 * _o(100), 1),
            "TEIOZO_FlowB": ("data", 0.7 * _o(100), 1),
    ...
    def process(self):
        ...
        dv = DecadesVariable(
            self.d["TEIOZO_conc"], name="O3_TECO", flag=DecadesBitmaskFlag
        )

        dv.flag.add_mask(
            self.d["STATUS_FLAG"],
            "instrument_alarm",
            "The status flag provided by the instrument is indicating an alarm state",
        )
        ...
        dv.flag.add_mask(self.d["WOW_FLAG"], flags.WOW, "The aircraft is on the ground")
