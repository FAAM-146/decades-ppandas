...
class BBR(QAMod):
    ...
    def make_solar_timeseries(self, fig: QAFigure) -> None:
        ax, ax2 = fig.timeseries_axes([0.1, 0.75, 0.8, 0.15], labelx=False, twinx=True)
    ...
    def make_upper_timeseries(self, fig: QAFigure) -> None:
        ax = fig.timeseries_axes([0.1, 0.43, 0.8, 0.3], labelx=False)
    ...
    def make_lower_timeseries(self, fig: QAFigure) -> None:
        ax = fig.timeseries_axes([0.1, 0.11, 0.8, 0.3])
